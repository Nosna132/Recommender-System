...
def main():
    ...
    closest_match = find_closest_match(movie_title, tmdb_data['title'].tolist())
    ...
    if closest_match:
        ...
        if filtering_method == "Collaborative Filtering":
            collab_filtering_result = collaborative_filtering(closest_match, collaborative_model, tmdb_data)
            ...
            content_based_filtering_result = content_based_filtering(closest_match, content_based_model, tmdb_data)
